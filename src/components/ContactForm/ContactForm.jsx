...
function ContactForm() {
  return (
    <div className="max-w-screen-lg mx-auto p-5">
      ...
      <div className="bg-[#FFF5F5] md:col-span-4 p-10 text-[#FF6B6B]">
      <p className="mt-4 text-sm leading-7 font-regular uppercase">
          ...
          <p className="mt-4 leading-7 text-[#FF6B6B]">
          ...
          <div className="flex items-center mt-5">
            <svg
              className="h-6 mr-2 text-[#FF6B6B]"
              fill="currentColor"
              version="1.1"
        ...
        <form className="md:col-span-8 p-10 bg-[#FFF5F5]">
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      <label className="block uppercase tracking-wide text-[#FF6B6B] text-xs font-bold mb-2" for="grid-first-name">
        First Name
      </label>
    ...
    <div className="w-full md:w-1/2 px-3">
      <label className="block uppercase tracking-wide text-[#FF6B6B] text-xs font-bold mb-2" for="grid-last-name">
        Last Name
      </label>
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full px-3">
      <label className="block uppercase tracking-wide text-[#FF6B6B] text-xs font-bold mb-2" for="grid-email">
        Email Address
      </label>
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full px-3">
      <label className="block uppercase tracking-wide text-[#FF6B6B] text-xs font-bold mb-2" for="grid-message">
        Your Message
      </label>
    ...
    <div className="flex justify-between w-full px-3">
      ...
      <button className="shadow bg-[#FF6B6B] hover:bg-[#FF9B6B] focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded" type="submit">
        Send Message
      </button>
    </div>
  </div>
